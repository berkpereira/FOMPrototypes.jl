...
function onecol_method_operator!(
    ...
    # temp_m_vec1 is taken up with the new y variable
    ws.scratch.base.temp_m_vec2 .= ws.scratch.method.Ax
    ws.scratch.base.temp_m_vec2 .*= -ws.method.ρ
    ws.scratch.base.temp_m_vec2 .+= ws.scratch.method.y_bar

    # multiply this by A'
    @views mul!(ws.scratch.base.temp_n_vec1, ws.p.A', ws.scratch.base.temp_m_vec2)
    ...
    # assign new iterates
    # consumes temp_n_vec1 and temp_m_vec1
